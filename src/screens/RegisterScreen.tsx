      ...
      <Card className="w-full max-w-sm">
        ...
        >
          ...
          <label className="flex min-h-[var(--touch-min)] items-start gap-[var(--space-2)] text-[length:var(--text-caption)]">
            ...
            <span>
              {/*
                **رابط يفتح النص فعلًا.** كانت الجملة تطلب «قرأت» بلا طريق
                للقراءة. وفي تبويب جديد، فلا يضيع ما كتبه في النموذج.
              */}
              قرأت{' '}
              <a href="/legal" target="_blank" rel="noopener" className="underline">
                سياسة الخصوصية وشروط الاستخدام
              </a>{' '}
              وأوافق عليهما. بياناتك المالية تبقى على خادمنا ولا تُرسل لأي جهة إلا بموافقة منفصلة
              تمنحها أنت.
            </span>
          </label>
